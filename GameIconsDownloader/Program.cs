...
namespace GameIconsDownloader
{
	class Program
	{
		...
		{
			ParseTagsPage(args[0]);
		}

		private static void ParseTagsPage(string outputFolder)
		{
		...
		public static void DownloadTags(string tag, string tempFolder, string outputRootFolder)
		{
